        ...
        <aside>
            ...
            <nav>
                <ul class="main-nav__links">
                    <li class="main-nav__link">
                        <form method="POST" action="/pharmacy/controller?command=medicine">
                ...
                <c:when test="${sessionScope.account.role == 'DOCTOR'}">
                    <nav>
                        <ul class="main-nav__links">
                            <li class="main-nav__link">
                                <form method="POST" action="/pharmacy/controller?command=prescriptions">
                                    <button class="button" type="submit">
            ...
            <c:otherwise>
                <nav>
                    <ul class="main-nav__links">
                        <li class="main-nav__link">
                            <form method="POST" action="/pharmacy/controller?command=purchases">
                                <button class="button" type="submit">
                        ...
                        <li class="main-nav__link">
                            <form method="POST" action="/pharmacy/controller?command=accountPrescriptions">
                                <button class="button" type="submit">
                        ...
                        <li class="main-nav__link">
                            <form method="POST" action="/pharmacy/controller?command=myPurchases">
                                <button class="button" type="submit">
